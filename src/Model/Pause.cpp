...
std::string Pause::getTitle()
{
	return title;
}

std::shared_ptr<Button> Pause::getQuitButton()
{
	return quitButton;
}

std::shared_ptr<Button> Pause::getBackButton()
{
	return backButton;
}

std::shared_ptr<Button> Pause::getRetryButton()
{
	return retryButton;
}

std::shared_ptr<Button> Pause::getResumeButton()
{
	return resumeButton;
}