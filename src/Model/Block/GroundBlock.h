...
#include "BlockData.h"
class GroundBlock : public BlockData
{

public:
	GroundBlock(std::shared_ptr<btRigidBody> rigidBody, std::shared_ptr<btCollisionShape> shape, std::shared_ptr<btDefaultMotionState> motionState, btScalar mass,
		...
		objectType = "Block-Normal-Ground";
	}
