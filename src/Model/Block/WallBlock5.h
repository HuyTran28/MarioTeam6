...
#include "BlockData.h"
class WallBlock5 : public BlockData
{

public:
	WallBlock5(std::shared_ptr<btRigidBody> rigidBody, std::shared_ptr<btCollisionShape> shape, std::shared_ptr<btDefaultMotionState> motionState, btScalar mass,
