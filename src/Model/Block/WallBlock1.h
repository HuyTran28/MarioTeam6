...
#include "BlockData.h"
class WallBlock1 : public BlockData
{

public:
	WallBlock1(std::shared_ptr<btRigidBody> rigidBody, std::shared_ptr<btCollisionShape> shape, std::shared_ptr<btDefaultMotionState> motionState, btScalar mass,
