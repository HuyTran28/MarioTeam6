...
#include "BlockData.h"
class WallBlock4 : public BlockData
{

public:
	WallBlock4(std::shared_ptr<btRigidBody> rigidBody, std::shared_ptr<btCollisionShape> shape, std::shared_ptr<btDefaultMotionState> motionState, btScalar mass,
