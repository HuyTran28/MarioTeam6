...
MenuModel::MenuModel() : StageModel(createMarioModel(Vector3{0.0f, 50.0f, 0.0f}, Vector3{3.0f, 3.0f, 3.0f}), Vector3{0.0f, 20.0f, 0.0f}, Vector3{-20.0f, 30.0f, 0.0f}, 60.0f, CAMERA_PERSPECTIVE)
{
