...
class PurpleMushroom : public ItemData
{
public:
	PurpleMushroom(std::shared_ptr<btRigidBody> rigidBody, std::shared_ptr<btCollisionShape> shape, std::shared_ptr<btDefaultMotionState> motionState
		...
		objectType = "Item-PurpleMushroom";
	}
