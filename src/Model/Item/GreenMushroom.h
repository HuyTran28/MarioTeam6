...
class GreenMushroom : public ItemData
{
public:
	GreenMushroom(std::shared_ptr<btRigidBody> rigidBody, std::shared_ptr<btCollisionShape> shape, std::shared_ptr<btDefaultMotionState> motionState
